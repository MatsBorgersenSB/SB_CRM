...
export const HUB_SECTION_ICONS: Record<string, SmartCRMIconName> = {
  ...
  "Attention & Next Best Actions": "needsAttention",
  "Next Action": "needsAttention",
  "Growth & Marketing Intelligence": "search",
  "Contacts & Stakeholders": "contact",
  "Activities & Documents": "activity",
  "Delivery & Execution": "project",
  Document: "document",
  Documents: "document",
  ...
  "Buying Center": "contact",
  "Executive Recon": "search",
  "Contract Audit": "document",
