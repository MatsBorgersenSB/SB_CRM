...
const INDUSTRY_TO_SECTORS: Record<string, ICPTargetSector[]> = {
  ...
  "Plastics Recycling": ["Cleantech", "Manufacturing"],
  "Rubber & Tire Processing": ["Manufacturing", "Cleantech"],
  "Textile Recovery": ["Cleantech", "Manufacturing"],
  "Chemical Manufacturing": ["Manufacturing", "Industrial"],
  "Petrochemicals": ["Manufacturing", "Industrial"],
  "Specialty Chemicals": ["Manufacturing", "Industrial"],
  "Waste Management": ["Cleantech", "Industrial"],
  "Municipal Solid Waste": ["Cleantech", "Industrial"],
  "Hazardous Waste Treatment": ["Cleantech", "Industrial"],
  "Construction & Demolition Waste": ["Cleantech", "Industrial"],
  "Sewage Sludge Treatment": ["Cleantech", "Industrial"],
  "E-Waste & Electronics Recycling": ["Cleantech", "Manufacturing"],
  "Recycling & Circular Economy": ["Cleantech", "Industrial"],
  "Biomass & Bioenergy": ["Energy", "Cleantech"],
  "Biochar & Carbon Removal": ["Cleantech", "Energy"],
  "Renewable Energy": ["Energy", "Cleantech"],
  "Energy & Infrastructure": ["Energy", "Cleantech"],
  "District Heating & Utilities": ["Energy", "Industrial"],
  "Oil & Gas": ["Energy", "Industrial"],
  "Hydrogen & Synthetic Fuels": ["Energy", "Cleantech"],
  "Agriculture & Agri-Processing": ["Industrial", "Cleantech"],
  "Forestry & Wood Processing": ["Industrial", "Cleantech"],
  "Pulp & Paper": ["Manufacturing", "Industrial"],
  "Food & Beverage Processing": ["Manufacturing", "Industrial"],
  "Animal By-products & Rendering": ["Industrial", "Cleantech"],
  "Aquaculture": ["Aquaculture", "Industrial"],
  "Fertilizer & Soil Amendments": ["Industrial", "Cleantech"],
  "Cement & Construction Materials": ["Manufacturing", "Industrial"],
  "Mining & Minerals Processing": ["Industrial", "Manufacturing"],
  "Metals & Steel": ["Manufacturing", "Industrial"],
  "Water & Wastewater Treatment": ["Cleantech", "Industrial"],
  "Industrial Manufacturing": ["Manufacturing", "Industrial"],
  "Industrial Technology": ["Industrial", "Manufacturing"],
  "Electronics & Electrical Equipment": ["Manufacturing", "Industrial"],
  "Automotive & Mobility": ["Manufacturing", "Transport"],
  "Packaging": ["Manufacturing", "Industrial"],
  "EPC & Engineering Contractors": ["Industrial", "Energy"],
  "Project Development": ["Energy", "Cleantech"],
  "Cleantech & Climate Tech": ["Cleantech", "Energy"],
  "Environmental Services": ["Cleantech", "Industrial"],
  "Research & Academia": ["Cleantech", "Industrial"],
  "Government & Municipalities": ["Cleantech", "Energy"],
  "Maritime & Ports": ["Transport", "Industrial"],
  "Logistics & Transport": ["Transport", "Industrial"],
  "Other / Diversified": ["Industrial", "Manufacturing"],
};
